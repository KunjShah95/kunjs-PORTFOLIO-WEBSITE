        ...
        <div className="fixed inset-0 z-[120] flex items-start justify-center px-4 pt-[20vh]">
          ...
          >
            ...
            <div className="p-2 max-h-72 overflow-y-auto">
              <p className="px-3 py-1.5 text-[10px] font-medium text-ink-tertiary uppercase tracking-wider">Navigation</p>
                ...
                {filteredCommands.length > 0 ? (
                  filteredCommands.map((cmd) => (
                    <button
                      ...
                      className="flex w-full items-center gap-3 px-3 py-2.5 rounded-md text-sm group hover:bg-sunken transition-colors"
                    >
                      <div className="w-8 h-8 rounded-md bg-sunken group-hover:bg-accent/10 group-hover:text-accent flex items-center justify-center transition-colors shrink-0">
                        <cmd.icon className="h-4 w-4 text-ink-tertiary group-hover:text-accent transition-colors" />
                      </div>
                  ...
                  <div className="py-8 text-center">
                    <p className="text-sm text-ink-tertiary">No results found</p>
                  </div>
                )}
              </div>
            </div>
