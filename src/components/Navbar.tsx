          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              >
                ...
                <span className="text-[10px] opacity-50">{searchHint}</span>
              </button>
          ...
          >
            ...
            >
              ...
              <div className="mt-8 flex items-center gap-3">
                ...
                <a href="mailto:kunjkshah05@gmail.com" aria-label="Email" className="p-2 border border-rule/10 rounded-lg hover:bg-elevated/30 hover:text-accent transition-colors">
