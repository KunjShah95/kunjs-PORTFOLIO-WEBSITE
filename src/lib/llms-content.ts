...
export async function getContent(): Promise<string> {
  ...
  lines.push('- https://kunjshah.vercel.app/')
  lines.push('')
  ...
  lines.push('')
  lines.push('- Home: https://kunjshah.vercel.app/')
  lines.push('- About: https://kunjshah.vercel.app/about')
  lines.push('- Projects: https://kunjshah.vercel.app/projects')
  lines.push('- Skills: https://kunjshah.vercel.app/skills')
  lines.push('- Experience: https://kunjshah.vercel.app/experience')
  lines.push('- Education: https://kunjshah.vercel.app/education')
  lines.push('- Labs: https://kunjshah.vercel.app/labs')
  lines.push('- AI Videos: https://kunjshah.vercel.app/ai-videos')
  lines.push('- Contact: https://kunjshah.vercel.app/contact')
  lines.push('')
  ...
  if (PROJECTS && PROJECTS.length > 0) {
    ...
    PROJECTS.forEach((project) => {
      ...
      if (project.slug) lines.push(`- https://kunjshah.vercel.app/projects/${project.slug}`)
      lines.push('')
    })
  }
